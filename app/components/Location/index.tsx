...
export default function Location() {
  return (
    <div  className="bg-teal-600 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-2 h-1 w-24 bg-sky-300 mx-auto rounded"></div>
        </div>

        {/* Google Maps Embed */}
        <div className="mt-16 rounded-lg shadow-2xl overflow-hidden">
          {/* IMPORTANT: Replace the 'src' with your Google Maps embed link */}
          <iframe
